...
module.exports = __webpack_require__("sPkI");
...
// EXTERNAL MODULE: external "antd/lib/layout/style"
var layout_style_ = __webpack_require__("Z6WE");
...
// CONCATENATED MODULE: ./components/OrderList/DataList.js
...
var DataList_DataList = function DataList(_ref) {
  ...
  var columns = [{
    ...
    render: function render(id, record) {
      ...
      }, "Detail ", record.name), external_react_default.a.createElement(divider_default.a, {
        type: "vertical"
...
/* harmony default export */ var OrderList_DataList = (Object(external_react_redux_["connect"])(mapStateToProps, {
...
// CONCATENATED MODULE: ./components/commons/forms/AddOrderForm.js
...
var AddOrderForm_AddOrderForm =
/*#__PURE__*/
function (_React$Component) {
  Object(inherits["a" /* default */])(AddOrderForm, _React$Component);
  ...
  function AddOrderForm() {
    ...
    Object(classCallCheck["a" /* default */])(this, AddOrderForm);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(AddOrderForm)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  Object(createClass["a" /* default */])(AddOrderForm, [{
    key: "render",
    value: function render() {
      ...
      return external_react_default.a.createElement(form_default.a, _extends({}, formItemLayout, {
        onSubmit: this.handleSubmit
      }), external_react_default.a.createElement(form_default.a.Item, {
        label: "\u0E04\u0E33\u0E2D\u0E18\u0E34\u0E1A\u0E32\u0E22"
      }, getFieldDecorator('description', config)(external_react_default.a.createElement(input_default.a.TextArea, {
        rows: 4,
        style: {
          width: 350
        }
      ...
      }, " \u0E1A\u0E32\u0E17")), external_react_default.a.createElement(form_default.a.Item, {
        wrapperCol: {
          xs: {
            span: 24,
            offset: 0
...
var AddOrderForm_mapStateToProps = function mapStateToProps(state) {
  return {
    cash: state.cash
  };
};

/* harmony default export */ var forms_AddOrderForm = (form_default.a.create({
  name: 'time_related_controls'
})(Object(external_react_redux_["connect"])(AddOrderForm_mapStateToProps, {
  setFormData: CashAction["f" /* setFormData */]
})(AddOrderForm_AddOrderForm)));
// EXTERNAL MODULE: ./components/commons/forms/CashDetail.js
var CashDetail = __webpack_require__("6wiw");

// CONCATENATED MODULE: ./components/OrderList/BtnAddNew.js




var BtnAddNew_BtnAddNew = function BtnAddNew(_ref) {
...
/* harmony default export */ var OrderList_BtnAddNew = (BtnAddNew_BtnAddNew);
// CONCATENATED MODULE: ./components/OrderList/index.js
...
var OrderList_Home = function Home(_ref) {
  var loadDataList = _ref.loadDataList;
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(MainBreadcrumb["a" /* default */], null), external_react_default.a.createElement(card_default.a, {
    ...
    optStatus: optStatus
  }), external_react_default.a.createElement(OrderList_BtnAddNew, {
    setOpen: setOpen
  }), external_react_default.a.createElement(OrderList_DataList, {
    handleOpenDetail: handleOpenDetail
  }), external_react_default.a.createElement(MainModal["a" /* default */], {
    title: "Add new order.",
    open: open,
    handleCancel: handleCancel
  }, external_react_default.a.createElement(forms_AddOrderForm, {
    handleCancel: handleCancel
  })), external_react_default.a.createElement(MainModal["a" /* default */], {
    title: "Detail.",
    open: openDetail,
...
/* harmony default export */ var OrderList = (Object(external_react_redux_["connect"])(null, {
  loadDataList: CashAction["b" /* loadDataList */]
})(OrderList_Home));
// EXTERNAL MODULE: ./services/HOCs/AuthHOC.js
var AuthHOC = __webpack_require__("2h8a");

// CONCATENATED MODULE: ./pages/order_list.js





var order_list_OrderListPage = function OrderListPage() {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement(OrderList, null));
};

/* harmony default export */ var order_list = __webpack_exports__["default"] = (Object(AuthHOC["a" /* default */])(order_list_OrderListPage));
