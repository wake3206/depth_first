...
// EXTERNAL MODULE: external "redux-act"
var external_redux_act_ = __webpack_require__("BiiH");

// CONCATENATED MODULE: ./state/reducers/RouteReducer.js
...
var setCurrentUrl = Object(external_redux_act_["createAction"])('setCurrentUrl'); //reducer

/* harmony default export */ var RouteReducer = (Object(external_redux_act_["createReducer"])(Object(defineProperty["a" /* default */])({}, setCurrentUrl, function (state, payload) {
  return Object(objectSpread["a" /* default */])({}, state, {
    currentUrl: payload
  });
}), init));
// EXTERNAL MODULE: ./state/reducers/CashReducer.js
var CashReducer = __webpack_require__("zAan");

// EXTERNAL MODULE: ./state/reducers/UserReducer.js
var UserReducer = __webpack_require__("Ct8J");

// CONCATENATED MODULE: ./state/reducers/index.js
...
var reducer = Object(external_redux_["combineReducers"])({
  ...
  styleState: StyleReducer["a" /* default */],
  routeInf: RouteReducer,
  cash: CashReducer["a" /* default */],
  userState: UserReducer["a" /* default */]
});
...
// EXTERNAL MODULE: ./antd_custom/styles.less
var styles = __webpack_require__("SR9S");
  ...
  Object(createClass["a" /* default */])(MyApp, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_redux_["Provider"], {
        store: store
      }, external_react_default.a.createElement(Component, null));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
