...
module.exports = __webpack_require__("GEoe");
...
// CONCATENATED MODULE: ./components/ApproveList/DataList.js
...
var DataList_DataList = function DataList(_ref) {
  ...
  var columns = [{
    ...
    render: function render(id, record) {
      ...
      }, "\u0E2D\u0E19\u0E38\u0E21\u0E31\u0E15\u0E34 "), external_react_default.a.createElement(divider_default.a, {
        type: "vertical"
      }), external_react_default.a.createElement("a", {
        href: "javascript:;",
        onClick: function onClick() {
          return handleInApprove(record);
        }
      }, "\u0E44\u0E21\u0E48\u0E2D\u0E19\u0E38\u0E21\u0E31\u0E15\u0E34"));
    }
  }];

  var handleApprove = function handleApprove(model) {
  ...
  var handleInApprove = function handleInApprove(model) {
    modal_default.a.confirm({
      title: 'ยืนยันไม่อนุมัติรายการ',
      onOk: function () {
        var _onOk2 = Object(asyncToGenerator["a" /* default */])(
        /*#__PURE__*/
...
/* harmony default export */ var ApproveList_DataList = (Object(external_react_redux_["connect"])(mapStateToProps, {
...
// CONCATENATED MODULE: ./components/ApproveList/index.js
...
var ApproveList_ApproveList = function ApproveList(_ref) {
  var loadDataList = _ref.loadDataList;
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(MainBreadcrumb["a" /* default */], null), external_react_default.a.createElement(card_default.a, {
    ...
    optStatus: optStatus
  }), external_react_default.a.createElement(ApproveList_DataList, {
...
/* harmony default export */ var components_ApproveList = (Object(external_react_redux_["connect"])(null, {
  loadDataList: CashAction["b" /* loadDataList */]
})(ApproveList_ApproveList));
// EXTERNAL MODULE: ./services/HOCs/AuthHOC.js
var AuthHOC = __webpack_require__("2h8a");

// CONCATENATED MODULE: ./pages/approve.js





var approve_ApprovePage = function ApprovePage() {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement(components_ApproveList, null));
};

/* harmony default export */ var approve = __webpack_exports__["default"] = (Object(AuthHOC["a" /* default */])(approve_ApprovePage));
